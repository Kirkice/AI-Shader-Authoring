...
namespace MarkupShaderGUI
{
    ...
    public class FolderPropertyClipboardData
    {
        ...
        /// <summary>ShaderGUI 类名标识，用于确认剪贴板数据由哪个 GUI 写入。</summary>
    ...
    public class SerializedPropertyEntry
    {
        ...
        /// <summary>(int)MaterialProperty.PropType: 0=Float, 1=Range, 2=Color, 3=Vector, 4=Texture。</summary>
        public int type;
